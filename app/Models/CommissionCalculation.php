...
class CommissionCalculation extends Model {
    ...
    protected $fillable = ['policy_id', 'agent_id', 'company_id', 'commission_structure_id', 'calculation_date', 'premium_amount', 'commission_rate', 'commission_amount', 'calculation_method', 'calculation_details', 'payment_status', 'payment_date', 'payment_reference', 'notes'];
