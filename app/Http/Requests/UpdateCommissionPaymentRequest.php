...
class UpdateCommissionPaymentRequest extends FormRequest {
    ...
    public function rules() {
        return [
            'payment_batch_number' => 'required|string|max:50|unique:commission_payments,payment_batch_number,' . $this->commissionPayment->id,
